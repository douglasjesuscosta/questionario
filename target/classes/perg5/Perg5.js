...
var url;
    if(bg=="org-abas"){
        url= "/questionario/organização-informação/org-abas.png";
    	...
    	url= "/questionario/organização-informação/org-importancia.png";
    	txt = "Organização por abas:";
		...
		url= "/questionario/organização-informação/org-tempopublicacao.png";
		...
		url= "/questionario/organização-informação/org-topicos.png";
		...
		url= "/questionario/organização-informação/org-topicos-e-cores.png";
